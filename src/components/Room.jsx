...
export function Room(props) {
    ...
    return (
        <group {...props} dispose={null}>
            ...
            {/* Scene Meshes */}
            <mesh geometry={nodes._________6_blinn1_0.geometry} material={customMaterials.curtain} />
            ...
            <mesh geometry={nodes.chair_body_blinn1_0.geometry} material={customMaterials.chair} />
            <mesh geometry={nodes.comp_blinn1_0.geometry} material={customMaterials.comp} />
            <mesh ref={screensRef} geometry={nodes.emis_lambert1_0.geometry} material={materials.lambert1} />
            <mesh geometry={nodes.pillows_blinn1_0.geometry} material={customMaterials.pillow} />
            <mesh geometry={nodes.radiator_blinn1_0.geometry} material={customMaterials.radiator} />
